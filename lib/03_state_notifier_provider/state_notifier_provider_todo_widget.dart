...
class StateNotifierProviderTodoWidget extends ConsumerWidget {
  const StateNotifierProviderTodoWidget({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('StateNotifierProvider Todo')),
      body: ListView(
        children: [
