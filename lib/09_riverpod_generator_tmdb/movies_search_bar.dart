...
class _SearchBarState extends ConsumerState<MoviesSearchBar> {
  ...
  void initState() {
    ...
    _debounce =
        _streamController.stream.debounceTime(const Duration(seconds: 1));
    _debounce.listen((String searchKeyword) {
      print('searchKeyword : $searchKeyword');
      ref.read(moviesSearchTextProvider.notifier).state = searchKeyword;
    });
  }
